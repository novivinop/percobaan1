      ...
      <Container className="nav-background">
        <Row>
          <Col className="mt-4 mx-auto" xs={12} md={12} lg={6}>
            <h2 className="fw-bold lh-base mt-3 intro mobile-center">
              Layanan Internet terbaik di kawasan Bekasi
            </h2>
            <p className="mt-3 intro mobile-center">
            ...
            <Button
              className="fw-bold text-white mt-3 mb-5 btn-sewa mobile-center"
        ...
        <Row className="mt-5">
          ...
          <Col className="mx-auto" lg={5}>
            <h4 className="fw-bold lh-base">
              Best Internet Service for any kind of product in Bekasi!
            </h4>
            <p className="mt-4">
              Nikmati layanan internet di Bekasi bersama Nusa Berkah Net jaminan
              harga lebih murah dibandingkan yang lain, kualitas pelayanan
              terbaik untuk akses internet mudah.
            </p>
            <tr>
              <td>
                <img
